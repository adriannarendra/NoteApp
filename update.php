            ...
            <div class="card shadow bg-body-tertiary rounded mb-4">
                <div class="card-body">
                    <form action="updateupdate.php" method="post">
                        <div class="mb-3">
                            <input class="form-control" name="title_note" placeholder="Title..." value="<?php echo $result['title_note'] ?>">
                        </div>
                        <div class="mb-3">
                            <textarea placeholder="Content..." class="form-control" rows="10" name="note_note" ><?php echo $result['note_note'] ?></textarea>
                            <input type="hidden" name="id" value="<?php echo $result['id_note'] ?>"></input>
                        </div>
